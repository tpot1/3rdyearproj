...
def loadChallenges():
	...
	chall2 = Challenge(challengeid=2, title='Not Bad', description='Check in to 5 lectures', complete=False, expiresat=currentTime+1987200, badge=Badge(iconName='/img/notbad.png'), points=30)
	chall3 = Challenge(challengeid=3, title='Golden Student', description='Check in to 10 lectures', complete=False, expiresat=currentTime+3196800, badge=Badge(iconName='/img/goldenstudent.png'), points=80)
	chall4 = Challenge(challengeid=4, title='Gotta Go Fast', description='Be the first in your class to check in to a lecture', complete=False, expiresat=currentTime+1382400, badge=Badge(iconName='/img/gottagofast.png'), points=30)
	...
	chall7 = Challenge(challengeid=7, title='Perfect Week', description='Attend every lecture in a week', complete=False, expiresat=currentTime+1382400, badge=Badge(iconName='/img/perfectweek.png'), points=20)
