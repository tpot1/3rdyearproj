...
def loadChallenges():
	...
	chall2 = Challenge(challengeid=2, title='First Blood', description='Be the first in your class to check in to the lecture', complete=False, expiresat=currentTime+72800, badge=Badge(iconName='/img/icon2.png'))
